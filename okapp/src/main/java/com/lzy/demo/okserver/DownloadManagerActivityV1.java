...
public class DownloadManagerActivityV1 extends BaseActivity implements View.OnClickListener, ExecutorWithListener.OnAllTaskEndListener {
    ...
    public void onAllTaskEnd() {
        for (DownloadInfo downloadInfo : allTask) {
            if (downloadInfo.getState() != DownloadManager.FINISH) {
                Toast.makeText(DownloadManagerActivityV1.this, "所有下载线程结束，部分下载未完成", Toast.LENGTH_SHORT).show();
                return;
            }
        }
        Toast.makeText(DownloadManagerActivityV1.this, "所有下载任务完成", Toast.LENGTH_SHORT).show();
    }
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(DownloadManagerActivityV1.this, R.layout.item_download_manager, null);
            ...
            if (apk != null) {
                Glide.with(DownloadManagerActivityV1.this).load(apk.getIconUrl()).error(R.mipmap.ic_launcher).into(holder.icon);
    ...
    private class ViewHolder implements View.OnClickListener {
        ...
        private void refresh() {
            String downloadLength = Formatter.formatFileSize(DownloadManagerActivityV1.this, downloadInfo.getDownloadLength());
            String totalLength = Formatter.formatFileSize(DownloadManagerActivityV1.this, downloadInfo.getTotalLength());
...
//                }
                ...
                String networkSpeed = Formatter.formatFileSize(DownloadManagerActivityV1.this, downloadInfo.getNetworkSpeed());
...
//                        }
    ...
    private class MyDownloadListener extends DownloadListener {
        ...
        public void onFinish(DownloadInfo downloadInfo) {
            Toast.makeText(DownloadManagerActivityV1.this, "下载完成:" + downloadInfo.getTargetPath(), Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onError(DownloadInfo downloadInfo, String errorMsg, Exception e) {
            if (errorMsg != null) Toast.makeText(DownloadManagerActivityV1.this, errorMsg, Toast.LENGTH_SHORT).show();
        }
    }
}
